...
The official source code for **Stoichiometry Representation Learning with Polymorphic Crystal Structures**, accepted at [NeurIPS 2023 workshop on AI for Scientific Discovery: From Theory to Practice (AI4Science)](https://ai4sciencecommunity.github.io/neurips23.html).
